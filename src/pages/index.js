...
const IndexPage = () => (
  <div>
    <div className="Hero">
      ...
      <h1>Learn to <br />design and code React 
      apps</h1>
      <p>Complete courses about the best tools and design system. Prototye and build apps with React and Swift.</p>
      <Link to="/page-2/">Watch the viedo</Link>
